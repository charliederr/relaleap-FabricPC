...
- `char_smoke`: `results/comparisons/phase0/runs/char_smoke`
- `char_smoke_pc`: `results/comparisons/phase0/runs/char_smoke_pc`
- `char_smoke_hep`: `results/comparisons/phase0/runs/char_smoke_hep`
